...
class AppViewModel(app:Application):AndroidViewModel(app){
    ...
    fun addSingle(examId:Long,uris:List<Uri>,done:()->Unit={})=viewModelScope.launch{repo.addSinglePaper(examId,uris);done()}
    fun addBulk(examId:Long,count:Int,uris:List<Uri>,done:()->Unit={})=viewModelScope.launch{repo.addBulk(examId,count,uris);done()}
